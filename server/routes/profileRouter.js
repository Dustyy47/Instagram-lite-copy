...
profileRouter.put('/posts/:id/like', getUserId, checkAuth, profileController.likePost);
profileRouter.put('/posts/:id/comment',getUserId,checkAuth,profileController.sendComment)

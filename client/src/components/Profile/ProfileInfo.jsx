        ...
        <div className="page-header">
            ...
            <div className="page-header__content">
                ...
                <div className="page-header__subscribesBlock">
                    <p onClick={() => openModal(subscribersId, 'Подписчики', 'Нет подписчиков')}
                       className="page-header__subscribers">{subscribersId.length} подписчиков</p>
                    <p onClick={() => openModal(subscribesId, 'Подписки', 'Нет подписок')}
                       className="page-header__subscribes">{subscribesId.length} подписок</p>
                </div>
            </div>
